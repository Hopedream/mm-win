...
static void __aos_list_add(aos_list_t *list, aos_list_t *prev, aos_list_t *next)
{
    next->prev = list;
    list->next = next;
    list->prev = prev;
...
static void aos_list_add_tail(aos_list_t *list, aos_list_t *head)
{
    __aos_list_add(list, head->prev, head);
}

static void __aos_list_del(aos_list_t *prev, aos_list_t *next)
{
    next->prev = prev;
    prev->next = next;
}
...
static void aos_list_del(aos_list_t *entry)
{
...
static int aos_list_empty(const aos_list_t *head)
{
    return (head->next == head);
}

// move list to new_list
static void aos_list_movelist(aos_list_t *list, aos_list_t *new_list)
{
