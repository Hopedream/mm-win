...
xmlNodeSetPtr get_xmlnode_values(aos_pool_t *p, xmlDocPtr doc, const char *xml_path);
...
**/
void oss_list_objects_owner_parse(aos_pool_t *p, xmlNodePtr cur_node, oss_list_object_content_t *content);
