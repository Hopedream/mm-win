...
namespace gloox
{
  ...
  class GLOOX_API MessageHandler
  {
    public:
	  ...
	  // lwt add 
	  virtual void handleOrgReq(std::string strFromJid, std::string strFromNick, 
		  std::string strOrgId, std::string strOrgName, std::string strMsgType, std::string strReqId, std::string strDestJid, std::string strDestNick) {};
  };
