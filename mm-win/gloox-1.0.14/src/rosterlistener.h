...
namespace gloox
{
  ...
  class GLOOX_API RosterListener
  {
    public:
       ...
       */
      virtual void handleItemSubscribed( const JID& jid, const std::string& strSendNick = "") = 0;
       ...
       */
      virtual bool handleSubscriptionRequest( const JID& jid, const std::string& msg, const std::string& strSendNick = "") = 0;
