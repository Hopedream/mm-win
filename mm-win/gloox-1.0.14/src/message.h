...
namespace gloox
{
  ...
  class GLOOX_API Message : public Stanza
  {
    ...
    public:
	  ...
	  public:
	  //lwt add  pubsub
	  pubSubInfo m_pubsubInfo;
	  std::string m_strFromJid;
	  std::string m_strFromNick;
	  std::string m_strOrgId;
	  std::string m_strOrgName;
	  std::string m_strOrgType;
	  std::string m_strReqId;
	  std::string m_strDestNick;
	  std::string m_strDestJid;
	  std::string m_strtoOrgId;
	  std::string m_strtoOrgName;
  };
